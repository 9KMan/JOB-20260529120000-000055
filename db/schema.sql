-- AgentFlow PostgreSQL Schema with Multi-Tenant RLS
...
-- RLS Policies for tenants (admins can access all, but we keep tenant_id for audit)
...
-- Function to enforce RLS on a session
